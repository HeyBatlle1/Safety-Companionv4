...
# Database initialization endpoint - REMOVE AFTER TABLES CREATED
@app.post("/api/init-db")
async def init_database(secret: str = ""):
    """
    Initialize database tables. 
    Call with secret=safety2026 to create all tables.
    REMOVE THIS ENDPOINT AFTER USE.
    """
    if secret != "safety2026":
        return {"error": "Invalid secret", "hint": "Pass secret=safety2026 as query param"}
    ...
    try:
        ...
        return {
            ...
            "next_step": "REMOVE this endpoint from main.py after verifying tables work"
        }
